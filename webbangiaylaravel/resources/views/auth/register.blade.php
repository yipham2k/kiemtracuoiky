                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                    <div class="text-center">
                                        <img src="{{ URL('images1/register.png') }}" class="img-fluid"
                                            alt="Sample image">
                                        <a class="mt-1 mb-2 pb-1 text-black" href="/">Tạo tài khoản và bắt đầu mua
                                            sắm đôi giày mà mình mơ ước.</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="{{ route('registerStore') }}">
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="ten_nguoi_dung" name="ten_nguoi_dung" required
                                                    autofocus autocomplete="ten_nguoi_dung" class="form-control" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="sdt" name="sdt" required autofocus
                                                    autocomplete="sdt" class="form-control" />
                                        ...
                                        <!-- Thông báo AJAX -->
                                        <p id="checkPassword" class="mt-1"></p>

                                        <div class="d-flex justify-content-center mx mt-3 mb-lg-4">
                                            <button type="submit" id="btnRegister"
                                                class="btn btn-primary btn-lg btn-block" disabled>Đăng ký</button>
                                        </div>
            ...
            function checkPasswordMatch() {
                ...
                if (confirmPassword.length > 0) {
                    if (password !== confirmPassword) {
                        $("#checkPassword").html("❌ Mật khẩu không khớp").css("color", "red");
                        $("#btnRegister").prop("disabled", true); // Khóa nút
                    } else {
                        $("#checkPassword").html("✅ Mật khẩu khớp").css("color", "green");
                        $("#btnRegister").prop("disabled", false); // Mở khóa nút
                    }
                } else {
                    $("#checkPassword").html("");
