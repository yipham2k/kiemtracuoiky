    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="../../../images2/{{ $giay['hinh_anh_1'] }}" alt="..." class="img-fluid rounded-start" />
                        {{-- style="height: 432px" --}}
                        <div class="row ">
                            @if ($giay['hinh_anh_2'])
                                <div class="col border ripple"><img src="../../../images2/{{ $giay['hinh_anh_2'] }}"
                                        alt="..." class="img-fluid rounded-start" /></div>
                            @else <div class="col border ripple"><img src="../../../images2/{{ $giay['hinh_anh_1'] }}"
                                        alt="..." class="img-fluid rounded-start" /></div>
                            @endif
                            @if ($giay['hinh_anh_3'])
                                <div class="col ripple"><img src="../../../images2/{{ $giay['hinh_anh_3'] }}" alt="..."
                                        class="img-fluid rounded-start" /></div>
                            @else <div class="col ripple"><img src="../../../images2/{{ $giay['hinh_anh_1'] }}"
                                        alt="..." class="img-fluid rounded-start" /></div>
                            @endif
                            @if ($giay['hinh_anh_4'])
                                <div class="col ripple"><img src="../../../images2/{{ $giay['hinh_anh_4'] }}" alt="..."
                                        class="img-fluid rounded-start" /></div>
                            @else <div class="col ripple"><img src="../../../images2/{{ $giay['hinh_anh_1'] }}"
                                        alt="..." class="img-fluid rounded-start" /></div>
                            @endif
