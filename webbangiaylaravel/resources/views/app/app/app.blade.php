...
<head>
    ...
    <title>SHOESVN</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL('images1/minhduc.jpg') }}">
...
<body style="padding: 0; margin: 0;">
    <button onclick="topFunction()" id="myBtn" title="Go to top"><img src="{{ URL('images1/scroll-top.png') }}"
            height="40"></button>
    <!-- Header -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/minhduc.jpg') }}" height="100"
                    alt="SHOESVN" loading="lazy" width="200"></a>
