...
<div class="container">
    ...
    <div class="card mb-3 shadow-1">
        <div class="card-body" style="margin-top:40px">
            <center>
                <h3 class="card-title" style="text-transform: uppercase;">THƯƠNG HIỆU ANH DUY</h3>
            </center>
        </div>
        <br>
    </div>
    ...
    <div class="tab-content" id="ex2-content">
        <div class="tab-pane fade show active" id="ex3-tabs-1" role="tabpanel" aria-labelledby="ex3-tab-1">
            <div class="row">
                ...
                @foreach ($giays as $giay)
                    @if ($dem < 5 && $giay['ten_thuong_hieu'] == 'Adidas')
                        <div class="col-md-3">
                            <div class="card" style="margin-bottom: 25px">
                                <a href="/cua-hang/san-pham={{ $giay['id_giay'] }}">
                                    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                        <center><img src="../../../images2/{{ $giay->hinh_anh_1 }}" class="img-fluid"
        ...
        <div class="tab-pane fade" id="ex3-tabs-2" role="tabpanel" aria-labelledby="ex3-tab-2">
            <div class="row">
                ...
                @endif
                @foreach ($giays as $giay)
                    @if ($dem < 5 && $giay['ten_thuong_hieu'] == 'Nike')
                        <div class="col-md-3">
                            <div class="card" style="margin-bottom: 25px">
                                <a href="/cua-hang/san-pham={{ $giay['id_giay'] }}">
                                    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
        ...
        <div class="tab-pane fade" id="ex3-tabs-3" role="tabpanel" aria-labelledby="ex3-tab-3">
            <div class="row">
                ...
                @endif
                @foreach ($giays as $giay)
                    @if ($dem < 5 && $giay['ten_thuong_hieu'] == 'Converse')
                        <div class="col-md-3">
                            <div class="card" style="margin-bottom: 25px">
                                <a href="/cua-hang/san-pham={{ $giay['id_giay'] }}">
                                    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            ...
                            <div class="col-md-3">
                                <div class="card" style="margin-bottom: 25px">
                                    <a href="/cua-hang/san-pham={{ $giaynoibat->id_giay }}">
                                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                            <center><img src="../../../images2/{{ $giaynoibat->hinh_anh_1 }}"
                                                ...
                                                <p class="card-text text-success">
                                                    ...
                                                    @foreach ($khuyenmais as $khuyenmai)
                                                        @if ($khuyenmai['ten_khuyen_mai'] == $giaynoibat->ten_khuyen_mai)
                                                            @if ($km = sprintf('%d', $giaynoibat->don_gia * 0.01 * $khuyenmai['gia_tri_khuyen_mai']))
                                                            @endif
                                                        @endif
                                                    @endforeach

                                                    <b>{{ number_format($giaynoibat->don_gia - $km, 0, ',', ',') }}
                                                        VNĐ</b>
                            ...
                            <div class="col-md-3">
                                <div class="card" style="margin-bottom: 25px">
                                    <a href="/cua-hang/san-pham={{ $giaymoinhat->id_giay }}">
                                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                            <center><img src="../../../images2/{{ $giaymoinhat->hinh_anh_1 }}"
                                                    class="img-fluid" style="height:306px; width:306px" /></center>
                                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);">
                                            </div>
                                        </div>
                                                ...
                                                <p class="card-text text-success">
                                                    ...
                                                    @foreach ($khuyenmais as $khuyenmai)
                                                        @if ($khuyenmai['ten_khuyen_mai'] == $giaymoinhat->ten_khuyen_mai)
                                                            @if ($km = sprintf('%d', $giaymoinhat->don_gia * 0.01 * $khuyenmai['gia_tri_khuyen_mai']))
                                                            @endif
                                                        @endif
                                                    @endforeach

                                                    <b>{{ number_format($giaymoinhat->don_gia - $km, 0, ',', ',') }}
                                                        VNĐ</b>
